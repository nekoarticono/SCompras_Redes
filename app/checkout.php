...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm'])) {
    ...
    $body = "<h1>Obrigado pela sua compra!</h1><p>Fatura: $invoiceNumber</p><p>Produto: {$cart['product']['name']}</p><p>Quantidade: {$cart['quantity']}</p><p>Total: €{$cart['total']}</p><p>Pontos ganhos: $earnedPoints</p>";
